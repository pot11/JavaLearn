...
import DDNS.Toolbox.NowString;
import DDNS.Toolbox.ProgressBar;
...
//        }
    ...
    private static String DNS_KEY = "efa15645a5f390c7465c5";
    ...
    private static String DNS_DOMAIN = "pot11.top"; // 查域名列表、更新DNS只能用域名
